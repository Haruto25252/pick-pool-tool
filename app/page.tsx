  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-4">
     ...
     {/* 対面設定フォーム */}
      ...
      {/* フッター */}
      <div className="mt-12 pb-6 flex flex-col items-center gap-2 text-gray-600">
        <div className="flex gap-4">
          ...
          <a href="https://github.com/Haruto25252/pick-pool-tool" target="_blank" rel="noopener noreferrer"
            className="hover:text-gray-400 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <p className="text-xs">VERSION v1.39</p>
        <p className="text-xs">© 2026 Produced by Haru</p>
      </div>
    </div>
